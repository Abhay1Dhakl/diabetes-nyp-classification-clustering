...
- `notebooks/02_classification.ipynb`: Model comparison on training data, then test-set evaluation.
- `notebooks/03_evaluation_error_analysis.ipynb`: Error analysis and inspection of common misclassifications.
- `notebooks/04_clustering.ipynb`: Runs unsupervised clustering on the cleaned dataset and saves cluster assignments.
- `notebooks/preprocessing_backup.ipynb`: Legacy preprocessing steps kept as a backup reference (optional).
...
3. `notebooks/03_evaluation_error_analysis.ipynb`
